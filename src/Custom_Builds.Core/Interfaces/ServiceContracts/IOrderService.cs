...
public interface IOrderService
{
    ...
    Task<Result<int>> GetPendingOrdersCount(Guid? currUserId, CancellationToken cancellationToken = default);
    ...
    Task<Result<OrderDetailsDto>> GetDetailsAsync (Guid orderId,Guid? currUserId, CancellationToken cancellationToken = default);
    Task<Result<OrderDTO>> UpdateStatus(Guid orderId, OrderStateEnum newStatus, CancellationToken cancellationToken = default);
}