        ...
        loadComponent: () =>
          ...
          data: {
            pagesData: [
              ...
              { icon: 'fa-solid fa-clock-rotate-left', name: 'Orders Management', goTo: 'orders-management' },
              { icon: 'fa-solid fa-headset', name: 'Inventory Management', goTo: 'inventory-management' },
